...
class TriangleMeshToBoxCollisionDetector
...
private: // private methods
	bool TestIntersection(
		...
		const Meson::Gravitas::Geometry::BoundingOrientedBox& p_boundingOrientedBox) const;
...
public: // public methods
	TriangleMeshToBoxCollisionDetector(void);
	~TriangleMeshToBoxCollisionDetector(void);
