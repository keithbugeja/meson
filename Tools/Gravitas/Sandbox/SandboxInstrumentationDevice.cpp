...
SandboxInstrumentationDevice::~SandboxInstrumentationDevice(void)
{
	HardwareResourceManager* pHardwareResourceManager
		= VistasEngine::GetInstance()->GetHardwareResourceManager();
...
const TMatrix4<Real>& SandboxInstrumentationDevice::GetTransform(void)
{
	return m_matTransform;
}

void SandboxInstrumentationDevice::SetTransform(const TMatrix4<Real>& p_matTransform)
{
...
const Meson::Gravitas::Instrumentation::Colour& SandboxInstrumentationDevice::GetColour(void)
{
	return m_colour;
}

void SandboxInstrumentationDevice::SetColour(const Meson::Gravitas::Instrumentation::Colour& p_colour)
{
	m_colour = p_colour;
...
Meson::Gravitas::Instrumentation::DrawMode::DrawMode SandboxInstrumentationDevice::GetDrawMode(void)
{
	return m_drawMode;
}

void SandboxInstrumentationDevice::SetDrawMode(Meson::Gravitas::Instrumentation::DrawMode::DrawMode p_drawMode)
{
	m_drawMode = p_drawMode;
}

void SandboxInstrumentationDevice::PushDeviceState(void)
{
...
void SandboxInstrumentationDevice::PopDeviceState(void)
{
